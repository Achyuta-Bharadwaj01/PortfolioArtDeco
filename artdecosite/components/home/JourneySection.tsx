  ...
  return (
    <article className="group relative flex w-[16.5rem] shrink-0 snap-start flex-col sm:w-[17.5rem] md:w-[18rem] lg:w-[19rem] xl:w-[20rem]">
      <div className="flex flex-col items-center">
        <span className="relative z-10 flex h-3 w-3 items-center justify-center rounded-full border border-camel/40 bg-parchment ring-4 ring-parchment transition-colors duration-300 group-hover:border-camel group-hover:bg-camel" />
      </div>
...
function TimelineConnector() {
  return (
    <span
      aria-hidden="true"
      className="mt-1.5 hidden h-px min-w-6 flex-1 shrink basis-10 bg-gradient-to-r from-gold/20 via-gold/35 to-gold/20 sm:block lg:min-w-12 lg:max-w-36"
    />
  );
}
    ...
    <section className="relative bg-cream pb-16 pt-4 lg:pb-24 lg:pt-6">
      ...
      <div className={`relative z-10 mx-auto w-full ${journeyMaxWidthClass} px-5 sm:px-6 lg:px-10 xl:px-12`}>
        ...
        <div className="relative -mx-5 sm:-mx-6 lg:-mx-10 xl:-mx-12">
          <HorizontalScrollArea className="scroll-px-5 pb-4 pt-4 sm:scroll-px-6 lg:scroll-px-10 xl:scroll-px-12">
